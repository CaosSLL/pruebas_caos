 ...
 */
class Usuario extends \Acme\TableroBundle\Entity\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'username', 'password', 'salt', 'rol', 'partidas');
        }
    ...
    public function getPartidas()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPartidas', array());
